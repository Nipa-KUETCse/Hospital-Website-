                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="{{ route('frontend.appointment') }}" class="dropdown-item active">Appointment</a>
                                <a href="{{ route('frontend.search') }}" class="dropdown-item">Search</a>
                            </div>
                        </div>
                        <a href="{{ route('frontend.contact') }}contact.html" class="nav-item nav-link">Contact</a>
                    </div>
                </div>
            </nav>
        </div>
